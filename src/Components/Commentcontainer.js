...
const commentsData=[
    {
        name:'bharath',
        text:'lorem ipsum fhehf dfhuef dhfuh',
        replies:[{
            name:'bharath',
            text:'lorem ipsum fhehf dfhuef dhfuh',
            replies:[]
