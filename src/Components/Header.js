...
const Header = () => {
  ...
  useEffect(()=>{
   const timer= setTimeout(() => {
    if(searchcache[searchtext]){
      setsuggest(searchcache[searchtext]);
 ...
 const Togglemenuhandler=()=>{
  ...
  return (
    <div className='sticky top-0 grid grid-flow-col shadow-lg py-4 bg-white '>
        ...
        <div className='col-span-10 justify-center '>
          <div className='align-center justify-center flex' > 
            ...
            className='border w-1/2 hover:bg-grey-500  hover:bg-slate-300  rounded-l-full bg-gray-100'  type='text'/>
            <button className='border border-gray-300 hover:bg-slate-300  rounded-r-full bg-gray-100 w-16 h-10 overflow-y'>Search</button>
           <div className='py-2 mx-2 hover:bg-slate-200 rounded-full'> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
  ...
  <path d="M6 10.5a.75.75 0 01.75.75v1.5a5.25 5.25 0 1010.5 0v-1.5a.75.75 0 011.5 0v1.5a6.751 6.751 0 01-6 6.709v2.291h3a.75.75 0 010 1.5h-7.5a.75.75 0 010-1.5h3v-2.291a6.751 6.751 0 01-6-6.709v-1.5A.75.75 0 016 10.5z" />
            ...
            <div className='bg-white rounded-lg py-2 px-2 shadow-lg border border-gray-200 visible fixed'>
              {showsuggetion && <ul className='fixed w-[32rem]'>s
                {
